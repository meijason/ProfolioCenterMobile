...
angular.module('portfolioCenter.services', ['ngResource'])
.constant("baseURL", "http://localhost:6002/")
// .constant("baseURL", "https://localhost:3443/")
.factory('portfoliosFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
...
.factory('portfolioFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "portfolio/:id", null, {
            'update': {
                method: 'PUT'
            }
        });
...
.factory('securitiesFactory', ['$resource', 'baseURL', function ($resource, baseURL) {

        return $resource(baseURL + "security/", null, {
            'update': {
                method: 'PUT'
            }
        });
...
.factory('portfolioItemFactory', ['$resource', 'baseURL', function ($resource, baseURL) {

        return $resource(baseURL + "portfolio/:id/:securityId", {id:"@id", securityId: "@securityId"}, {
            'update': {
                method: 'PUT'
            }
        });
